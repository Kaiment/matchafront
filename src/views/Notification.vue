<template lang="pug">
    .full-width
        .hero
            ...
            .hero-body
                .container
                    .thumbnails.columns.is-multiline
                        .column.is-8-mobile.is-offset-2-mobile.is-half-tablet.is-one-third-widescreen
                            profile_thumbnail(img_src='https://lolstatic-a.akamaihd.net/frontpage/apps/prod/LolGameInfo-Harbinger/en_US/8588e206d560a23f4d6dd0faab1663e13e84e21d/assets/assets/images/gi-landing-top.jpg' firstname='tamer', lastname='lapute' age='67', bio='YEE')
                        .column.is-8-mobile.is-offset-2-mobile.is-half-tablet.is-one-third-widescreen
                            profile_thumbnail(firstname='tamer', lastname='lapute' age='67', bio='YEE')
                        .column.is-8-mobile.is-offset-2-mobile.is-half-tablet.is-one-third-widescreen
                            profile_thumbnail(firstname='tamer', lastname='lapute' age='67', bio='YEE')
                        .column.is-8-mobile.is-offset-2-mobile.is-half-tablet.is-one-third-widescreen
                            profile_thumbnail(firstname='tamer', lastname='lapute' age='67', bio='YEE')
